...
- `generate_docs.py`: Script utilizado para convertir la tabla CSV generada en documentos Markdown listos para leer, detallados a continuación.
...
2. Para procesar el nuevo CSV y obtener las estadísticas de las palabras clave de los UX Smells, ejecuta:
   ...
   ```
3. Finalmente, para generar y actualizar los archivos de documentación Markdown basados en el CSV actual (`issue_details.md` y `issue_links.md`), ejecuta:
   ```bash
